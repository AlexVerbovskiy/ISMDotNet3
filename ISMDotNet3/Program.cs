...
namespace ISMDotNet3
{
    class Program
    {
        public static double[] InputArray()
        {
            ...
            c_elements = int.Parse(Console.ReadLine());
            double[] arr=new double[c_elements];
        ...
        public static void PrintArray(double[] arr)
        {
            ...
            Console.WriteLine();
        } //виведення елементів масиву на консоль
        static void Main(string[] args)
        {
            Console.InputEncoding = Encoding.UTF8;
            Console.OutputEncoding = Encoding.UTF8;
            double[] arr = InputArray();
            Console.WriteLine($"Сума негативних елементів: {SumNegetivesArray(arr)}");
            Console.WriteLine($"Максимальний елемент масиву: {MaxElement(arr)}");
            Console.WriteLine($"Індекс максимального елементу масива: {IndexMaxElement(arr)}");
            Console.WriteLine($"Максимальний елемент масиву за модулем: {MaxAbsElement(arr)}");
            Console.WriteLine($"Сума індексів додатніх елементів: {SumIndexesPositiveElements(arr)}");
            Console.WriteLine($"Кількість цілих елементів: {CountWholeElements(arr)}");
            Console.Write("Cортування масиву за спаданням: ");
            PrintArray(SortArray(arr));
            Console.Write("Видалення негативних елементів: ");
            PrintArray(DeleterNegetiveElements(arr));
        }
    }
}
